 ...
 */
import { nextUid, createBlankEntry } from "./worldbook.js";
/** 根据 uid 查找条目 */
export function findByUid(entries, uid) {
    return entries.find((e) => e.uid === uid);
}
/** 根据多个 uid 查找条目 */
export function findByUids(entries, uids) {
 ...
 * @returns 新建的条目
 */
export function addEntry(entries, overrides = {}) {
 ...
 * @returns 新建的条目列表
 */
export function addEntries(entries, overridesList) {
 ...
 * @returns 被删除的条目
 */
export function removeEntries(entries, uids) {
    const set = new Set(uids);
    const deleted = [];
 ...
 */
export function updateEntry(entries, uid, updates) {
 ...
 */
export function reassignUids(entries) {
